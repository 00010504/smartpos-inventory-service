...
import (
	...
	"github.com/Invan2/invan_inventory_service/events/handlers"
...
func NewPubSubServer(log logger.Logger, producer *kafka.Producer, consumer *kafka.Consumer, strgPG storage.StoragePgI, elastic storage.StorageES) (PubSubServer, error) {
	return &pubSubServer{
		log:           log,
		producer:      producer,
