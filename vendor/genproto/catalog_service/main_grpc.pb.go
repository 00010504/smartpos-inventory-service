...
type CatalogServiceClient interface {
	...
	GetProductFields(ctx context.Context, in *common.Request, opts ...grpc.CallOption) (*GetProductFieldsResponse, error)
...
func (c *catalogServiceClient) GetProductFields(ctx context.Context, in *common.Request, opts ...grpc.CallOption) (*GetProductFieldsResponse, error) {
...
type CatalogServiceServer interface {
	...
	GetProductFields(context.Context, *common.Request) (*GetProductFieldsResponse, error)
...
func (UnimplementedCatalogServiceServer) GetProductFields(context.Context, *common.Request) (*GetProductFieldsResponse, error) {
...
func _CatalogService_GetProductFields_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).GetProductFields(ctx, req.(*common.Request))
	}
	return interceptor(ctx, in, info, handler)
}
